...
export const AwsDynamoDbManagedMetricNames = {
    ...
    ACCOUNT_PROVISIONED_READ_CAPACITY_UTILIZATION: "AccountProvisionedReadCapacityUtilization",
    ACCOUNT_PROVISIONED_WRITE_CAPACITY_UTILIZATION: "AccountProvisionedWriteCapacityUtilization",
    ...
    MAX_PROVISIONED_TABLE_READ_CAPACITY_UTILIZATION: "MaxProvisionedTableReadCapacityUtilization",
    MAX_PROVISIONED_TABLE_WRITE_CAPACITY_UTILIZATION: "MaxProvisionedTableWriteCapacityUtilization",
